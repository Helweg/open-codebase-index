...
- **OpenCode peer dependency range**: Narrowed `peerDependencies["@opencode-ai/plugin"]` from `^1.0.0` to `^1.3.4` to reflect object entrypoint compatibility, while keeping the runtime dependency pin at `1.3.13`.
