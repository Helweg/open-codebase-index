...
; Direct calls, including under try/await and with trailing closures.
((call_expression
  .
...
; First inheritance item of a non-generic class.
(class_declaration
...
; First inheritance item of a generic class.
(class_declaration
  declaration_kind: "class"
  name: (_)
  (type_parameters)
...
; Any item with a preceding inheritance_specifier is a conformance.
; The intentional absence of an anchor between the two items matters.
(class_declaration
  declaration_kind: "class"
  (inheritance_specifier)
  (inheritance_specifier
...
; Annotated conformance placed first: , , etc.
(class_declaration
  declaration_kind: "class"
  (attribute)
  .
